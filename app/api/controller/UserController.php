...
class UserController extends AuthController
{
    public function userInfo()
    {
        ...
        $user = User::where('id', $user['id'])->field('id,phone,realname,pay_password,up_user_id,is_active,invite_code,ic_number,level,balance,topup_balance,poverty_subsidy_amount,digital_yuan_amount,can_open_digital,team_bonus_balance,created_at,qq,avatar,signin_balance')->find()->toArray();
