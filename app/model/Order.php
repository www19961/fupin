...
class Order extends Model
{
    ...
    public static function orderPayComplete($order_id, $project, $user_id, $day)
    {
        ...
        if($project['project_group_id'] == 1) {
            ...
            Order::where('id', $order['id'])->update([
                ...
                'pay_time' => time(),
                'end_time' => $end_time,
                //$next_bonus_time + $order['period']*24*3600,
                'gain_bonus' => 0,
            ...
            $end_time = strtotime("+{$day} day", strtotime(date('Y-m-d')));
            Order::where('id', $order['id'])->update([
                'status' => 2,
                'period' => $day,
                'pay_time' => time(),
